    ...
    for(let i = 0; i < team.length; i++) {
        ...
        switch(teamArray.getRole()) {
            case 'Manager':
                ...
                break;
            case 'Engineer':
                const engineer = new Engineer(teamArray.id, teamArray.name, teamArray.email, teamArray.officeNumber);
                cards.push(generateEngineerCard(engineer));
                break;
            case 'Intern':
                const intern = new Intern(teamArray.id, teamArray.name, teamArray.email, teamArray.officeNumber);
